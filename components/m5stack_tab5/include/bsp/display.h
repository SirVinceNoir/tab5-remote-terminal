...
/* LOCAL PATCH: M5Stack's factory firmware uses 965 Mbps for ST712x panels
 * (both ST7123 and ST7121 timing sub-variants), not 1000 -- see vsync
 * timing patch in bsp_display.c for context. */
#define BSP_LCD_MIPI_DSI_LANE_BITRATE_MBPS (965)
